    ...
    parts: [
      {
        ...
        guides: [
          ...
          },
          {
            ...
            copy: "Identify what each question asks, form a short answer, then compare it with the three options.",
          ...
          },
          {
            ...
            copy: "Choose the best answer, then identify the simple mistake in each wrong option across two rounds.",
            progressId: "reading.part1.general-distractor-detective",
            route: "distractor-detective",
            icon: FlaskConical,
            eyebrow: "Skill trainer",
          },
        ],
    ...
    parts: [
      ...
      },
      {
        ...
        guides: [
          ...
          },
          {
            ...
            copy: "Guide the class through a quick read, open gap predictions, clue reveals, sentence placement and class feedback.",
            progressId: "reading.part3.advanced-free-things-live-lesson",
            route: "live/free-things-lesson",
            icon: Users,
            eyebrow: "Teacher resource · Live lesson",
            teacherOnly: true,
          },
        ],
        icon: TextCursorInput,
      },
      {
        ...
        guides: [
          ...
          {
            title: "Host a Part 4 live activity",
            copy: "Choose Option Jury or a traditional all-options activity with class answers and highlighted evidence.",
