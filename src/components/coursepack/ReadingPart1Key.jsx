// src/components/coursepack/ReadingPart1Key.jsx

import { useMemo, useState } from "react";
import Seo from "../common/Seo";
import { readingPart1Key } from "../../data/packKey/readingPart1";
...
export default function ReadingPart1Key() {
  const sections = useMemo(() => readingPart1Key.sections || [], []);
  ...
  return (
    <div className="packkey-page">
      ...
      <Seo
        title="Reading Part 1 Key | Seif Aptis Trainer"
        description="Answer key for Reading Part 1 tasks in the Seif Aptis Trainer pack."        
        canonical="https://aptis-trainer.beeskillsenglish.com/pack-key/reading-part-1"
      />

      <div className="panel" style={{ maxWidth: 980, margin: "0 auto" }}>
        <h1 className="pk-title">{readingPart1Key.title} — Key</h1>
        <p className="pk-subtitle">
        Detailed answer key for the Reading Part 1 training pages shown in the pack.
        </p>
