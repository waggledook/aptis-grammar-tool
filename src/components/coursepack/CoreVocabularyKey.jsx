...
import { coreVocabularyKey } from "../../data/packKey/coreVocabulary";
...
export default function CoreVocabularyKey() {
  const sections = useMemo(() => coreVocabularyKey.sections || [], []);
  ...
  return (
    <div className="packkey-page">
      ...
      <Seo
        title="Core Vocabulary Key | Seif Aptis Trainer"
        description="Answer key for Core Vocabulary tasks in the Seif Aptis Trainer pack."
        canonical="https://aptis-trainer.beeskillsenglish.com/pack-key/core-vocabulary"
      />

      <div className="panel" style={{ maxWidth: 980, margin: "0 auto" }}>
        <h1 className="pk-title">{coreVocabularyKey.title} — Key</h1>
        <p className="pk-subtitle">
          Answer key for the Core Vocabulary chapter (Training + Exam Practice). More sections can be added over time.
        </p>
