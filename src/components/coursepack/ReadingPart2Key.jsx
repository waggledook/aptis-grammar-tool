// src/components/coursepack/ReadingPart2Key.jsx

import { useMemo, useState } from "react";
import Seo from "../common/Seo";
import { readingPart2Key } from "../../data/packKey/readingPart2";
...
export default function ReadingPart2Key() {
  const sections = useMemo(() => readingPart2Key.sections || [], []);
  ...
  return (
    <div className="packkey-page">
      ...
      <Seo
        title="Reading Part 2 Key | Seif Aptis Trainer"
        description="Answer key for Reading Part 2 tasks in the Seif Aptis Trainer pack."
        canonical="https://aptis-trainer.beeskillsenglish.com/pack-key/reading-part-2"
      />

      <div className="panel" style={{ maxWidth: 980, margin: "0 auto" }}>
        <h1 className="pk-title">{readingPart2Key.title} — Key</h1>

        <p className="pk-subtitle">
          Detailed answer key for Reading Part 2.
        </p>
