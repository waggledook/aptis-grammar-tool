...
import { coreGrammarKey } from "../../data/packKey/coreGrammar";
...
export default function CoreGrammarKey() {
  const sections = useMemo(() => coreGrammarKey.sections || [], []);
  ...
  return (
    <div className="packkey-page">
      ...
      <Seo
        title="Core Grammar Key | Seif Aptis Trainer"
        description="Answer key for Core Grammar tasks in the Seif Aptis Trainer pack."
        canonical="https://aptis-trainer.beeskillsenglish.com/pack-key/core-grammar"
      />

      <div className="panel" style={{ maxWidth: 980, margin: "0 auto" }}>
        <h1 className="pk-title">{coreGrammarKey.title} — Key</h1>
        <p className="pk-subtitle">
          Answer key for the Core Grammar chapter (Training + Exam Practice). More sections can be added over time.
        </p>
