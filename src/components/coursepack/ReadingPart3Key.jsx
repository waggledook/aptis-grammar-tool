// src/components/coursepack/ReadingPart3Key.jsx

import { useMemo, useState } from "react";
import Seo from "../common/Seo";
import { readingPart3Key } from "../../data/packKey/readingPart3";
...
export default function ReadingPart3Key() {
  const sections = useMemo(() => readingPart3Key.sections || [], []);
  ...
  return (
    <div className="packkey-page">
      ...
      <Seo
        title="Reading Part 3 Key | Seif Aptis Trainer"
        description="Answer key for Reading Part 3 tasks in the Seif Aptis Trainer pack."
        canonical="https://aptis-trainer.beeskillsenglish.com/pack-key/reading-part-3"
      />

      <div className="panel" style={{ maxWidth: 980, margin: "0 auto" }}>
        <h1 className="pk-title">{readingPart3Key.title} — Key</h1>
        <p className="pk-subtitle">
          Detailed answer key for Reading Part 3 (opinion matching).
        </p>
