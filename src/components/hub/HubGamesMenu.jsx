...
export default function HubGamesMenu() {
  const navigate = useNavigate();

  return (
    <div className="menu-wrapper hub-menu-wrapper">
      <Seo
        title="Games | Seif Hub"
        description="Choose a language game inside the Seif English Hub."
      />
      ...
      <p className="menu-sub">Choose a game to begin.</p>

      <div className="whats-new-banner hub-status-banner">
        <div className="whats-new-copy">
          <span className="whats-new-label">Games</span>
          <p>
            Learn through quick challenge-style games that sharpen your reactions, accuracy, and noticing skills.
          </p>
        </div>
      ...
      <style>{`
        ...
        .hub-menu-wrapper .menu-card {
          ...
          justify-content: space-between;
          background:
            linear-gradient(180deg, rgba(30, 47, 84, 0.96), rgba(22, 36, 66, 0.96)),
            radial-gradient(circle at top right, rgba(255, 191, 73, 0.12), transparent 40%);
        }
