...
export default function HubGrammarMenu() {
  const navigate = useNavigate();

  return (
    <div className="menu-wrapper hub-menu-wrapper">
      <Seo
        title="Grammar Activities | Seif Hub"
        description="Choose a grammar activity inside the Seif English Hub."
      />
      ...
      <p className="menu-sub">Choose a grammar activity to begin.</p>
