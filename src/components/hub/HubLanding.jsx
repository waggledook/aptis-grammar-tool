        ...
        <>
          <div className="menu-grid">
            ...
            >
              ...
              <p>Practice tasks and academy follow-up work inside the shared app layout.</p>
            </button>
            ...
            >
              ...
              <p>Open the listening menu and access guided dictation work inside the hub.</p>
            </button>
            ...
            >
              ...
              <p>Review progress and keep all your academy practice in one protected space.</p>
            </button>
            ...
            {user?.role === "admin" && (
              ...
              >
                <h3>Admin Tools</h3>
                <p>Manage user roles, Seif Hub access windows, and the wider shared app setup.</p>
              </button>
            )}
          </div>
