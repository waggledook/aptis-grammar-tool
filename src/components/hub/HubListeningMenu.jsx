...
export default function HubListeningMenu() {
  const navigate = useNavigate();

  return (
    <div className="menu-wrapper hub-menu-wrapper">
      <Seo
        title="Listening Activities | Seif Hub"
        description="Choose a listening activity inside the Seif English Hub."
      />
      ...
      <p className="menu-sub">Choose a listening activity to begin.</p>
