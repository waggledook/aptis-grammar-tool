...
import OteSpeakingPart2AdvancedGuide from "./products/ote/OteSpeakingPart2AdvancedGuide.jsx";
...
import OteSpeakingPart3LanguageReference from "./products/ote/OteSpeakingPart3LanguageReference.jsx";
...
import OteSpeakingPart45DebateGuide from "./products/ote/OteSpeakingPart45DebateGuide.jsx";
import OteSpeakingPart45DebateGuidedTask from "./products/ote/OteSpeakingPart45DebateGuidedTask.jsx";
import OteSpeakingPart45FollowUpGuidedTask from "./products/ote/OteSpeakingPart45FollowUpGuidedTask.jsx";
import OteSpeakingPart45DebatePractice from "./products/ote/OteSpeakingPart45DebatePractice.jsx";
...
import OteGeneralReadingDistractorLaboratory from "./products/ote/OteGeneralReadingDistractorLaboratory.jsx";
import OteReadingPart1Guide from "./products/ote/OteReadingPart1Guide.jsx";
import OteReadingPart2PeopleAndChoicesGuide from "./products/ote/OteReadingPart2PeopleAndChoicesGuide.jsx";
import OteReadingPart2ThreeProfilesGuide from "./products/ote/OteReadingPart2ThreeProfilesGuide.jsx";
import OteReadingPart3Guide from "./products/ote/OteReadingPart3Guide.jsx";
import OteReadingPart4Guide from "./products/ote/OteReadingPart4Guide.jsx";
      ...
      const notificationIds = (
        await Promise.all(
          studentIds.map(async (studentId) => {
            const [part1, part2, part3, part4, miniTests, dictationSessions, vocabSets, readingProgress, oteTrainingProgress] =
              await Promise.all([
                ...
                fetchRecentOteTrainingProgress(5, studentId),
              ]);
            ...
            return [
              ...
              ...(oteTrainingProgress || []).map((entry) => ({
                id: `ote-training:${studentId}:${entry.progressId}:${timestampToMs(entry.updatedAt)}`,
                createdAt: entry.updatedAt,
              })),
            ];
          })
...
<Routes>
  ...
  <Route
    path="/ote/speaking/part-1-interview/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart1AdvancedGuide nativeRoutes={false} />
        : <OteSpeakingPart1Guide nativeRoutes={false} />
    }
  />
  <Route path="/ote/speaking/part-1-interview/practice" element={<OteSpeakingPart1Practice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/ote/speaking/part-1-interview/practice/:setId" element={<OteSpeakingPart1Practice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/ote/speaking/part-2-voicemails" element={<OteSpeakingPart2Menu user={user} nativeRoutes={false} />} />
  <Route
    path="/ote/speaking/part-2-voicemails/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart2AdvancedGuide nativeRoutes={false} />
        : <OteSpeakingPart2Voicemails nativeRoutes={false} />
    }
  />
  <Route
    path="/ote/speaking/part-2-voicemails/guided-message-1"
    element={
      user?.oteVersion === "advanced"
        ? <Navigate to={getSitePath("/ote/speaking/part-2-voicemails")} replace />
        : <OteSpeakingPart2GuidedMessage1 nativeRoutes={false} />
    }
  />
  <Route
    path="/ote/speaking/part-2-voicemails/guided-message-2"
    element={
      user?.oteVersion === "advanced"
        ? <Navigate to={getSitePath("/ote/speaking/part-2-voicemails")} replace />
        : <OteSpeakingPart2GuidedMessage2 nativeRoutes={false} />
    }
  />
  <Route
  ...
  <Route path="/ote/speaking/parts-4-5-debate/teacher-bank" element={<OteSpeakingPart45DebatePractice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} teacherBank />} />
  <Route path="/ote/speaking/parts-4-5-debate/teacher-bank/:setId" element={<OteSpeakingPart45DebatePractice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} teacherBank />} />
  <Route path="/ote/speaking/parts-3-4" element={<OteSpeakingPart34Menu user={user} nativeRoutes={false} />} />
  <Route
    path="/ote/speaking/parts-3-4/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart3AdvancedGuide nativeRoutes={false} />
        : <OteSpeakingPart34Guide nativeRoutes={false} />
    }
  />
  ...
  <Route
    path="/ote/speaking/parts-3-4-guide"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart3AdvancedGuide nativeRoutes={false} />
        : <OteSpeakingPart34Guide nativeRoutes={false} />
  ...
  <Route path="/ote/speaking/parts-3-4-practice" element={<OteSpeakingPart34Practice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/ote/speaking/parts-3-4-practice/:setId" element={<OteSpeakingPart34Practice nativeRoutes={false} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/ote/reading" element={<OteReadingMenu user={user} nativeRoutes={false} />} />
  ...
  <Route path="/ote/reading/general/part-4-long-text/guide" element={<OteReadingPart4Guide nativeRoutes={false} />} />
  <Route path="/ote/reading/advanced/part-1-short-texts/practice/:setId" element={<OteAdvancedReadingPart1Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/advanced/part-2-matching/practice/:setId" element={<OteAdvancedReadingPart2Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/advanced/part-3-gapped-text/practice/:setId" element={<OteAdvancedReadingPart3Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/general/part-3-gapped-text/practice/:setId" element={<OteGeneralReadingPart3Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/advanced/part-4-long-text/practice/:setId" element={<OteAdvancedReadingPart4Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/general/part-4-long-text/practice/:setId" element={<OteGeneralReadingPart4Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/general/part-1-short-texts/practice/:setId" element={<OteGeneralReadingPart1Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/general/part-2-matching/practice/:setId" element={<OteGeneralReadingPart2Practice user={user} nativeRoutes={false} />} />
  <Route path="/ote/reading/:variant/:partId" element={<OteReadingPartShell user={user} nativeRoutes={false} />} />
  ...
  <Route
    ...
    element={<OteWritingRegisterBasics user={user} onRequireSignIn={() => setShowAuth(true)} nativeRoutes={false} />}
  />
  <Route
    path="/ote/writing/training/email/register-gaps"
    element={<OteWritingRegisterGapTrainer user={user} onRequireSignIn={() => setShowAuth(true)} nativeRoutes={false} />}
  />
  <Route path="/ote/writing/training/essay/guide" element={<OteWritingEssayGuide nativeRoutes={false} />} />
  ...
  <Route
    ...
    element={
      isOteSite
        ? <OteCourseLanding nativeRoutes />
        : <Navigate to={getSitePath("/ote/level-test")} replace />
    }
  />
  <Route path="/speaking/part-1-interview" element={<OteSpeakingPart1Menu user={user} nativeRoutes={isOteSite} />} />
  <Route
    path="/speaking/part-1-interview/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart1AdvancedGuide nativeRoutes={isOteSite} />
        : <OteSpeakingPart1Guide nativeRoutes={isOteSite} />
    }
  />
  <Route path="/speaking/part-1-interview/practice" element={<OteSpeakingPart1Practice nativeRoutes={isOteSite} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/speaking/part-1-interview/practice/:setId" element={<OteSpeakingPart1Practice nativeRoutes={isOteSite} user={user} onRequireSignIn={() => setShowAuth(true)} />} />
  <Route path="/speaking/part-2-voicemails" element={<OteSpeakingPart2Menu user={user} nativeRoutes={isOteSite} />} />
  <Route
    path="/speaking/part-2-voicemails/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart2AdvancedGuide nativeRoutes={isOteSite} />
        : <OteSpeakingPart2Voicemails nativeRoutes={isOteSite} />
    }
  />
  <Route
    path="/speaking/part-2-voicemails/guided-message-1"
    element={
      user?.oteVersion === "advanced"
        ? <Navigate to={getSitePath("/speaking/part-2-voicemails")} replace />
        : <OteSpeakingPart2GuidedMessage1 nativeRoutes={isOteSite} />
    }
  />
  <Route
    path="/speaking/part-2-voicemails/guided-message-2"
    element={
      user?.oteVersion === "advanced"
        ? <Navigate to={getSitePath("/speaking/part-2-voicemails")} replace />
  ...
  <Route path="/speaking/parts-4-5-debate/teacher-bank" element={<OteSpeakingPart45DebatePractice nativeRoutes={isOteSite} user={user} onRequireSignIn={() => setShowAuth(true)} teacherBank />} />
  <Route path="/speaking/parts-4-5-debate/teacher-bank/:setId" element={<OteSpeakingPart45DebatePractice nativeRoutes={isOteSite} user={user} onRequireSignIn={() => setShowAuth(true)} teacherBank />} />
  <Route path="/speaking/parts-3-4" element={<OteSpeakingPart34Menu user={user} nativeRoutes={isOteSite} />} />
  <Route
    path="/speaking/parts-3-4/overview"
    element={
      user?.oteVersion === "advanced"
        ? <OteSpeakingPart3AdvancedGuide nativeRoutes={isOteSite} />
        : <OteSpeakingPart34Guide nativeRoutes={isOteSite} />
    }
  />
  ...
  {isOteSite && (
    <>
      ...
      <Route path="/reading/general/part-4-long-text/guide" element={<OteReadingPart4Guide nativeRoutes />} />
      <Route path="/reading/advanced/part-1-short-texts/practice/:setId" element={<OteAdvancedReadingPart1Practice user={user} nativeRoutes />} />
      <Route path="/reading/advanced/part-2-matching/practice/:setId" element={<OteAdvancedReadingPart2Practice user={user} nativeRoutes />} />
      <Route path="/reading/advanced/part-3-gapped-text/practice/:setId" element={<OteAdvancedReadingPart3Practice user={user} nativeRoutes />} />
      <Route path="/reading/general/part-3-gapped-text/practice/:setId" element={<OteGeneralReadingPart3Practice user={user} nativeRoutes />} />
      <Route path="/reading/advanced/part-4-long-text/practice/:setId" element={<OteAdvancedReadingPart4Practice user={user} nativeRoutes />} />
      <Route path="/reading/general/part-4-long-text/practice/:setId" element={<OteGeneralReadingPart4Practice user={user} nativeRoutes />} />
      <Route path="/reading/general/part-1-short-texts/practice/:setId" element={<OteGeneralReadingPart1Practice user={user} nativeRoutes />} />
      <Route path="/reading/general/part-2-matching/practice/:setId" element={<OteGeneralReadingPart2Practice user={user} nativeRoutes />} />
      <Route path="/reading/:variant/:partId" element={<OteReadingPartShell user={user} nativeRoutes />} />
...
<Route
  ...
  element={
    isOteSite
      ? <OteReadingMenu user={user} nativeRoutes />
      : (
        <ReadingMenu
          user={user}
          aptisAccess={aptisAccess}
